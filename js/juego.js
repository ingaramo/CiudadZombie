...
y entender que es lo que hace en cada una de sus partes. */
 //Variable que sirve para identificar el ultimo obstaculo colisionado 
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 120, 430, 60, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 444, 440, 60, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 400, 440, 60, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 400, 80, 15, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 470, 120, 15, 30, 1),
    new Obstaculo('imagenes/valla_vertical.png', 300, 400 , 30, 60, 1),  
    new Obstaculo('imagenes/bache.png', 444, 410 , 15, 15, 1),  
    new Obstaculo('imagenes/bache.png', 160, 200 , 30, 30, 1),  
    new Obstaculo('imagenes/bache.png', 100, 260 , 20, 20, 1),  
    new Obstaculo('imagenes/bache.png', 160, 390 , 25, 25, 1),  
    new Obstaculo('imagenes/auto_verde_abajo.png', 850, 100 , 20, 40, 1),  
    new Obstaculo('imagenes/auto_verde_derecha.png', 430, 210 , 40, 20, 1),  
  ...
  rangoMov: {desdeX: 0, hastaX: 800, desdeY: 0, hastaY: 400},
  enemigos: [
    new ZombieCaminante ('imagenes/zombie1.png', 100, 100, 10, 10, 2, {desdeX: 0, hastaX: 800, desdeY: 0, hastaY: 400}),
    new ZombieCaminante ('imagenes/zombie2.png', 500, 250, 10, 10, 2, {desdeX: 0, hastaX: 800, desdeY: 0, hastaY: 400}),
    new ZombieCaminante ('imagenes/zombie3.png', 750, 280, 10, 10, 2, {desdeX: 750, hastaX: 850, desdeY: 0, hastaY: 500}),
    new ZombieCaminante ('imagenes/zombie4.png', 800, 100, 10, 10, 2, {desdeX: 0, hastaX: 800, desdeY: 0, hastaY: 400}),
    new ZombieConductor ('imagenes/tren_horizontal.png', 0, 322, 90, 30, 2, {desdeX: 0, hastaX: 900, desdeY: 0, hastaY: 577},'h'),
    new ZombieConductor ('imagenes/tren_vertical.png', 644, 470, 30, 90, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577},'v'),
    new ZombieConductor ('imagenes/tren_vertical.png', 678, 0, 30, 90, 2, {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577},'v'),
...
Juego.dibujar = function() {
  ...
  Dibujante.dibujarRectangulo('red', 760, 520, 125, 40);
...
Juego.chequearColisiones = function(x, y) {
  ...
  this.obstaculos().forEach(function(obstaculo) {
    if (this.intersecan(obstaculo, this.jugador, x, y)) {
      //Si un obstaculo se colisiona 2 veces seguidas a la segunda no quita vida
      if (this.jugador.ultimoObstaculoChocado != obstaculo){ 
        obstaculo.chocar(this.jugador);
      }
      puedeMoverse = false
      this.jugador.ultimoObstaculoChocado= obstaculo;
    }
  }, this)
  return puedeMoverse
};
